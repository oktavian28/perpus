                ...
                <div class="table-responsive">
                    <form method="post">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $query = mysqli_query($koneksi, "INSERT INTO peminjaman(BukuID,UserID,TanggalPeminjaman,TanggalPengembalian,StatusPeminjaman) values('$UlasanID',$UserID,'$tanggalpeminjaman','$tanggaldikembalikan','$statusdipinjam') ");
